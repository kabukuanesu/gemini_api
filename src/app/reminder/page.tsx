...
const navigation = [
  ...
  { name: "Notifications", href: "/reminder", current: true },
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                  <div className="max-w-xl lg:max-w-lg">
                    ...
                    <p className="mt-4 text-lg leading-8 text-gray-300">
                      To receive notifications, please subscribe.
                    </p>
                  ...
                  <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                    <div className="flex flex-col items-start">
                      ...
                      <dd className="mt-2 leading-7 text-gray-400">
                        Get weekly articles from us to stay informed about skin
                        health issues.
                      </dd>
                    </div>
                    <div className="flex flex-col items-start">
                      ...
                      <dd className="mt-2 leading-7 text-gray-400">
                        This platform is official, and we have a zero-tolerance
                        policy towards any form of spamming.
                      </dd>
                    </div>
                  </dl>
                </div>
